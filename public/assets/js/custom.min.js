    ...
    return {
        init: function () {
            ...
            jQuery("#menu").length > 0 && $("#menu").metisMenu(),
                ...
                ((n = window.outerHeight) > 0 ? n : screen.height) && $(".content-body").css("min-height", n - 180 + "px"),
                ...
                t(), function () {
                    ...
                    $(".dlab-demo-trigger").on("click", function () {
                        ...
                        $(".dlab-demo-close, .bg-close").on("click",
                            function () { $(".dlab-demo-panel").removeClass("show") }),
            ...
            e > 1024 && $(".metismenu  li").unbind().each(function (e) {
                if ($("ul", this).length > 0) {
                    var t = (a = $("ul:first", this).css("display", "block")).offset().left,
                        n = a.width(), a = $("ul:first", this).removeAttr("style"),
